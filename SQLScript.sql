...
Create table PostTracker(Post_Id varchar(100) Not Null,Media_Id varchar(255) Not Null,User_Id varchar(255),Likes Boolean,Comment varchar(2000),ActivityTime TimeStamp,Primary Key(Activity_Id),Foreign Key(User_Id) References VaultUser(User_Id),Foreign Key(Media_Id) References Media(Media_Id) );
