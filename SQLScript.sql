...
mysql>  INSERT INTO Media (User_Id, Type, File_Path, Upload_date, Description) VALUES ('deepti15', 'photo', '../logos/First Post.png', '2024-12-21', 'A beautiful Garden image');

mysql>  insert into UserProfile(User_Id,First_Name,Last_Name,BirthDate,Profile_Desc) values('deepti15','Deepti','Mishra','1986-12-15','I am excited to show this project!!!');
mysql> select * from UserProfile;
+----------+------------+-----------+------------+--------------------------------------+
| User_Id  | First_Name | Last_Name | Birthdate  | Profile_Desc                         |
+----------+------------+-----------+------------+--------------------------------------+
| deepti15 | Deepti     | Mishra    | 1986-12-15 | I am excited to show this project!!! |
+----------+------------+-----------+------------+--------------------------------------+
